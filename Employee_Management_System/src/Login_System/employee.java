...
public class employee {
	...
	{
		frame = new JFrame();
		frame.setBounds(100, 100, 1214, 502);
		...
		btnNewButton.addActionListener(new ActionListener() 
		{
			public void actionPerformed(ActionEvent e) 
			{
				...
				{
					JOptionPane.showMessageDialog(null, "ID is not Formate");
				}
		...
		panel_1.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255), new Color(160, 160, 160)), "Update", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
		panel_1.setBounds(29, 361, 525, 78);
		frame.getContentPane().add(panel_1);
		panel_1.setLayout(null);
		
		JLabel lblEmployeeid_1 = new JLabel("Employee_ID");
		lblEmployeeid_1.setFont(new Font("Times New Roman", Font.BOLD, 18));
		lblEmployeeid_1.setBounds(10, 22, 193, 33);
		...
		scrollPane.setBounds(582, 11, 606, 339);
		...
		btnDelete.setBounds(638, 376, 120, 40);
		...
		btnClear_1_1.setBounds(834, 376, 120, 40);
